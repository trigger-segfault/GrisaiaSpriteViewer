...
namespace Grisaia.SpriteViewer.Windows {
	...
	public class FolderBrowserDialog {
		...
		/// <summary>
		///  Using title text to look for the top level dialog window is fragile.<para/>
		///  In particular, this will fail in non-English applications.
		/// </summary>
		private const string _topLevelSearchString = "Browse For Folder";

		/// <summary>
		///  These should be more robust.  We find the correct child controls in the dialog by using the GetDlgItem
		///  method, rather than the FindWindow(Ex) method, because the dialog item IDs should be constant.
		/// </summary>
		...
		/// <summary>
		///  Calling this method is identical to calling the ShowDialog method of the provided FolderBrowserDialog,
		///  except that an attempt will be made to scroll the Tree View to make the currently selected folder visible
