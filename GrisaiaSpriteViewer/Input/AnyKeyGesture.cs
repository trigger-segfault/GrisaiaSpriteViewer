...
namespace Grisaia.Mvvm.Input {
	...
	public class AnyKeyGesture : InputGesture {
		...
		///  This allows setting KeyBinding.Key and KeyBinding.Modifiers without regard to order.
		/// </summary>
		/// <param name="key">Key</param>
		/// <param name="modifiers">Modifiers</param>
		...
		/// <summary>
		///  Returns a string that can be used to display the AnyKeyGesture. If the DisplayString was set by the
		///  constructor, it is returned. Otherwise a suitable string is created from the Key and Modifiers, with any
		...
		/// <returns>True - AnyKeyGesture matches, false otherwise.</returns>
		public override bool Matches(object targetElement, InputEventArgs inputEventArgs) {
			...
			if (keyEventArgs != null && IsDefinedKey(keyEventArgs.Key)) {
				return (((int) Key == (int) keyEventArgs.Key) && (Modifiers == Keyboard.Modifiers));
			}
			return false;
		}
