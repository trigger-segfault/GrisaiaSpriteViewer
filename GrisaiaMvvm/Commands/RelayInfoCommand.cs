...
namespace Grisaia.Mvvm.Commands {
	public class RelayInfoCommand : RelayCommand, IRelayInfoCommand, IRelayCommand {
		...
		/// <summary>
		///  The UI specific info for the command.
		/// </summary>
		...
		/// <summary>
		///  Constructs the <see cref="RelayInfoCommand"/>.
		/// </summary>
		/// <param name="execute">
		///  The execution logic. IMPORTANT: If the action causes a closure, you must set
		///  <paramref name="keepTargetAlive"/> to true to avoid side effects.
		/// </param>
		/// <param name="keepTargetAlive">
		///  If true, the target of the Action will be kept as a hard reference, which might cause a memory leak. You
		///  should only set this parameter to true if the action is causing a closures.<para/>
		...
		///  The execution status logic. IMPORTANT: If the func causes a closure, you must set
		///  <paramref name="keepTargetAlive"/> to true to avoid side effects.
		/// </param>
		/// <param name="keepTargetAlive">
		///  If true, the target of the Action will be kept as a hard reference, which might cause a memory leak. You
		...
		/// <summary>
		///  Executes the method without a parameter.
		/// </summary>
