...
namespace Grisaia.Mvvm {
	/// <summary>
	///  A base class for objects of which the collection must be observable.
	/// </summary>
	public abstract class ObservableCollectionObject : INotifyCollectionChanged {
		#region Fields

		/// <summary>
		///  True if the collection is raising a <see cref="CollectionChanged"/> event.
		/// </summary>
		...
		/// <summary>
		///  Occurs after the collection's items change.
		/// </summary>
		...
		/// <summary>
		///  Raises a new <see cref="CollectionChanged"/> event that describes a
		///  <see cref="NotifyCollectionChangedAction.Reset"/> change.
		/// </summary>
		...
		protected void RaiseCollectionChanged(NotifyCollectionChangedAction action, object newItem, object oldItem) {
		...
		protected void RaiseCollectionChanged(NotifyCollectionChangedAction action, IList newItems, IList oldItems) {
		...
		/// <param name="oldItems">The original items that are replaced.</param>
		/// <param name="startingIndex">The starting index of the items being replaced.</param>
		protected void RaiseCollectionChanged(NotifyCollectionChangedAction action, IList changedItems, int index,
			int oldIndex)
		{
		...
		/// <summary>
		///  Throws an exception if the user is attempting to modify the list during a <see cref="CollectionChanged"/>
		///  event.
		/// </summary>
		/// 
