...
namespace Grisaia.Mvvm.Services {
	/// <summary>
	///  How icons are stored and displayed.
	/// </summary>
	[Serializable]
	...
	/// <summary>
	///  The states for caching an icon.
	/// </summary>
	...
	/// <summary>
	///  A structure containing both a cached icon and name.
	/// </summary>
	[Serializable]
	public class IconAndName {
		...
		/// <summary>
		///  Constructs a new <see cref="IconAndName"/>.
		/// </summary>
