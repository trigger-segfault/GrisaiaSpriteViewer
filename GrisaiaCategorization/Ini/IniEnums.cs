...
namespace Grisaia.Ini {
	/// <summary>
	///  The available property assignment styles for ini documents.
	/// </summary>
	...
	/// <summary>
	///  The available comment styles for ini documents.
	/// </summary>
	...
	/// <summary>
	///  The formats an enum can be stored in.
	/// </summary>
	...
	/// <summary>
	///  Extensions for the ini enums.
	/// </summary>
	public static class IniEnumExtensions {
		/// <summary>
		///  Gets the string representation of the ini assignment style.
		/// </summary>
		...
		/// <summary>
		///  Gets the string representation of the ini comment style.
		/// </summary>
