...
namespace Grisaia.Asmodean {
	...
	public sealed partial class Anm : IReadOnlyCollection<AnmFrame> {
		...
		private Anm(string fileName, Anm.ANMHDR hdr, Anm.ANMFRM[] frames) {
			FileName = fileName;
			Unknown = hdr.Unknown;
		...
		/// </summary>
		/// <param name="fileName">The base file name of the <see cref="Anm"/>.</param>
		...
		/// </summary>
		/// <param name="directory">The directory of the <see cref="Anm"/>.</param>
		/// <param name="fileName">The base file name of the <see cref="Anm"/>.</param>
